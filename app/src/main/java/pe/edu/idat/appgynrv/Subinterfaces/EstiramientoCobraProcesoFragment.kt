 ...
 * Use the [EstiramientoCobraProcesoFragment.newInstance] factory method to
...
class EstiramientoCobraProcesoFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment EstiramientoCobraProcesoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            EstiramientoCobraProcesoFragment().apply {

 ...
 * Use the [PreFelicidadesEjer5Fragment.newInstance] factory method to
...
class PreFelicidadesEjer5Fragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PreFelicidadesEjer5Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PreFelicidadesEjer5Fragment().apply {

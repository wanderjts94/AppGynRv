 ...
 * Use the [EstiramientoPechoProcesoFragment.newInstance] factory method to
...
class EstiramientoPechoProcesoFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment EstiramientoPechoProcesoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            EstiramientoPechoProcesoFragment().apply {

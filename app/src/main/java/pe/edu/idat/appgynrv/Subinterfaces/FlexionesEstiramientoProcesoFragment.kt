 ...
 * Use the [FlexionesEstiramientoProcesoFragment.newInstance] factory method to
...
class FlexionesEstiramientoProcesoFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FlexionesEstiramientoProcesoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FlexionesEstiramientoProcesoFragment().apply {

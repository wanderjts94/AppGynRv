 ...
 * Use the [PreFelicidadesEjer3Fragment.newInstance] factory method to
...
class PreFelicidadesEjer3Fragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PreFelicidadesEjer3Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PreFelicidadesEjer3Fragment().apply {

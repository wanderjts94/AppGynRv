 ...
 * Use the [PreFelicidadesEjer4Fragment.newInstance] factory method to
...
class PreFelicidadesEjer4Fragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PreFelicidadesEjer4Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PreFelicidadesEjer4Fragment().apply {

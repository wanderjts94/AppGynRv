 ...
 * Use the [SaltoEnTijeraProcesoFragment.newInstance] factory method to
...
class SaltoEnTijeraProcesoFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SaltoEnTijeraProcesoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SaltoEnTijeraProcesoFragment().apply {
